...
if(sampleword.indexOf(tofind) >0){
    console.log("The Character searched is "+tofind+" and is found at: "+(sampleword.indexOf(tofind)+1));
}
else{
    console.log("The Character searched is "+tofind+" and it is not found.");
}
console.log("-----------------------------------------------------------------");
...
let position = 2;
let tosearch = "Clinic";
console.log("The element searched is: "+tosearch+" and is found at: "+(sampledata.indexOf(tosearch)+1));
...
//Question 5
console.log("5.Program to print an array in reverse order");
